...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"80%","padding":"10px 9%","margin":"0 0 10px","background":"#fff"}' label="作业文件" prop="zuoyewenjian">
            <file-upload
            tip="点击上传作业文件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"width":"80%","padding":"10px 9%","margin":"0 0 10px","background":"#fff"}' label="上传时间" prop="shangchuanshijian" >
              <el-date-picker
          ...
          <el-form-item :style='{"width":"80%","padding":"10px 9%","margin":"0 0 10px","background":"#fff"}' label="文件内容" prop="wenjianneirong">
            <editor 
