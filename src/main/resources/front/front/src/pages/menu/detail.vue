		...
		<div class="attr" :style='{"padding":"20px","margin":"0 0 0 240px","alignItems":"center","background":"#f5f5f5","flexDirection":"column","display":"flex","position":"relative","justifyContent":"center"}'>
			...
			<div class="info" :style='{"border":"1px solid #999","width":"120%","padding":"10px","margin":"80px 0 0 -250px","background":"#fff"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 2% 10px","borderColor":"#999","background":"#fff","borderWidth":"0 0 1px","display":"inline-block","width":"45%","borderStyle":"solid"}'>
					<div class="lable" :style='{"padding":"0 5px","color":"#999","textAlign":"left","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>菜单</div>
					<div  :style='{"padding":"0 10px","color":"#666","textAlign":"left","display":"inline-block","width":"calc(100% - 110px)","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.menujson}}</div>
				</div>
