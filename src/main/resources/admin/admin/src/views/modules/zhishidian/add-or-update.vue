<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="知识名称" prop="zhishimingcheng">
					<el-input v-model="ruleForm.zhishimingcheng" placeholder="知识名称" clearable  :readonly="ro.zhishimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="知识名称" prop="zhishimingcheng">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="知识详情" prop="zhishixiangqing">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zhishixiangqing" label="知识详情" prop="zhishixiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.zhishixiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zhishixiangqing = this.ruleForm.zhishixiangqing.replace(reg,'../../../springboot70teu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
