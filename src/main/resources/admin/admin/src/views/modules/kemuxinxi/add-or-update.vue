<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="科目名称" prop="kemumingcheng">
					<el-input v-model="ruleForm.kemumingcheng" placeholder="科目名称" clearable  :readonly="ro.kemumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="科目名称" prop="kemumingcheng">
