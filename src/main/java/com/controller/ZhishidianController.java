...
public class ZhishidianController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZhishidianEntity zhishidian,
		...
		if(tableName.equals("jiaoshi")) {
			zhishidian.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZhishidianEntity zhishidian, 
		HttpServletRequest request){
        EntityWrapper<ZhishidianEntity> ew = new EntityWrapper<ZhishidianEntity>();
